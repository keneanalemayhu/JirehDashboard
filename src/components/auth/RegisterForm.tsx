...
export function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const hasBusinessData = businessName?.trim() || businessType?.trim() || formattedBusinessPhone;
      
      if (hasBusinessData) {
        registrationData.business_profile = {};
        if (businessName?.trim()) registrationData.business_profile.business_name = businessName.trim();
        if (businessType?.trim()) registrationData.business_profile.business_type = businessType.trim().toLowerCase();
        if (formattedBusinessPhone) {
          registrationData.business_profile.business_phone = formattedBusinessPhone;
        }
      }
