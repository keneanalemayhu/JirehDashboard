...
export function ExpenseForm({
  ...
  const [formData, setFormData] = useState<ExpenseFormData>({
    ...
    recurringFrequency: initialData?.recurringFrequency ?? "monthly" as "daily" | "weekly" | "monthly" | "yearly" | undefined,
  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        recurringEndDate: initialData.recurringEndDate ? new Date(initialData.recurringEndDate) : undefined,
        paymentMethod: initialData.paymentMethod ?? "Cash" as "Cash" | "Credit Card" | "Debit Card" | "Bank Transfer" | "Check" | "Mobile Payment" | "Other",
      });
      setErrors({
        name: false,
        amount: false,
